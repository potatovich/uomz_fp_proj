...
def launch():
    try:
        ...
        if file_name != 'Выберите файл' and s_from < s_to and s_from >= 0 and s_to >= 2 and s_to - s_from >= 2:
        ...
        messagebox.showerror(title="Запуск приостановлен", message="Возникла ошибка на этапе построения графика!")
...
def select_file(event):
    try:
        ...
        messagebox.showerror(title="Запуск приостановлен", message="Возникла ошибка на этапе выбора файла!")
